...
export default function Registro() {
  ...
  return (<>
    <Box sx={{ display: "Flex" }} style={{ backgroundImage: 'url(https://img.freepik.com/free-photo/ultra-detailed-nebula-abstract-wallpaper-4_1562-749.jpg)' }}>
      {/*<Sidebar/>*/}
        ...
        <ThemeProvider theme={defaultTheme} >
          <Grid container component="main"  >
            ...
            <Grid
              ...
              md={7}
              sx={{
                backgroundImage: 'url(https://thelogisticsworld.com/wp-content/uploads/2023/01/ilustracion-de-seguridad-cibernetica.jpg)',
