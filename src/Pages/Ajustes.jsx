...
import { updateDoc, collection, doc, getDocs, getDoc } from "firebase/firestore";
                ...
                <Box component="main" sx={{ flexGrow: 1, p: 12, my: 2 }}>
                    ...
                    <Box sx={{ my: 4 }}>
                        ...
                        <Grid container component="main" sx={{ my: 5 }}>
                            ...
                            <Grid container component="section" sx={{ my: 2 }}>
                                <Button variant="contained" endIcon={<EditIcon />} onClick={(e) => handleSubmit(e)}>Actualizar</Button>
                            </Grid>
                        </Grid>
